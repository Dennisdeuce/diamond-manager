...
git config user.email "dennisdeuce@users.noreply.github.com" >> _push_log.txt 2>&1
git config user.name "Dennisdeuce" >> _push_log.txt 2>&1
...
git commit -m "feat: Diamond Manager - baseball lineup web app" >> _push_log.txt 2>&1
